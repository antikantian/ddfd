...
int main(int argc, char** argv) try
{
	...
	{
		cout << "Usage: " << endl;
		cout << "./resnet34_train /path/to/positive/images /path/to/negative/images /path/to/validation/images" << endl;
		return 1;
	}
	...
	anet_type net; deserialize("../resources/resnet34_1000_imagenet_classifier.dnn") >> net;

	cout << net << endl;

	dnn_trainer<anet_type> trainer(net,sgd(weight_decay, momentum));

	trainer.be_verbose();
	trainer.set_learning_rate(initial_learning_rate);
	trainer.set_synchronization_file("resnet34_trainer_state_file.dat", std::chrono::minutes(10));
	...
	serialize("resnet34_face_detection.dnn") << net;
